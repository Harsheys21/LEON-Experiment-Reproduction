...
class LeonModel:
    ...
    def __init__(self, model_port):
        ...
        context = ray.init(namespace=namespace, 
                           _temp_dir= "/home/harsh/tmp/ray_tmp/log/ray")   
        print(context.address_info)
        ray_address = context.address_info['address']
        with open('/home/harsh/LeonProject/LEON/conf/ray_address.txt', 'w') as f:
            f.write(ray_address)
...
class SimpleLeonModel(LeonModel):
    ...
    def __init__(self, model_port):
        ...
        with open ("/home/harsh/LeonProject/LEON/conf/ray_address.txt", "r") as file:
            ray_address = file.read().replace('\n', '')
        context = ray.init(address=ray_address, namespace=namespace, _temp_dir="/home/harsh/tmp/ray_tmp/log/ray") # init only once
        print(context.address_info)
